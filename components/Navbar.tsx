...
const Navbar = () => {
  ...
  return (
    ...
    <div className="h-full w-full mx-auto max-w-[1350px] px-4 py-6 md:px-20 sticky top-0 z-10">
      <nav
        className={`mx-auto w-full h-full flex items-center gap-8 transition-all duration-500 ease-in-out border border-transparent rounded-full px-4 py-2   
        ${
          isScrolled
      ...
      >
        <div
          className={`size-8 transition-all duration-500 ease-in-out dark:bg-slate-600 bg-slate-900 
